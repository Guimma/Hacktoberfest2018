...
class Pilha{
    ...
    public void inserir(Instituicao newInst){
...
public class Ex2{
  ...
  public static void main(String[] args) throws Exception{
    ...
    for(int i=0;i<ops;i++){
        ...
        switch (line[0]){
            case "I":{
                pilha.inserir(readInst(path,Integer.parseInt(line[1])));
                break;
            }
            case "R":{
                Instituicao rem = pilha.remover();
                MyIO.println("(R) " + rem.getNome());
                break;
            }   
        }
    }
    pilha.mostrar(pilha.top);
  }
}